...
extern void msg_spin_unlock_irqrestore(spinlock_t *, unsigned long, int, int);
static inline void spin_unlock_irqrestore(spinlock_t *lock, unsigned long flags)
{
	//raw_spin_unlock_irqrestore(&lock->rlock, flags);
	msg_spin_unlock_irqrestore(lock, flags, msqid_from_fs_to_kernel, msqid_from_kernel_to_fs);
}
